            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                   ...
                   if(user.Role==null)
                    ...
                    var PathToFlie = _hostEnvironment.WebRootPath + Path.DirectorySeparatorChar.ToString()
                    ...
                    string HtmlBody = "";
                    using(StreamReader streamReader = System.IO.File.OpenText(PathToFlie))
                    {
                    ...
                    string messageBody = string.Format(HtmlBody,
                        subject, String.Format("{0:dddd, d MMMM yyyy}", DateTime.Now),
                        user.Name,
                        user.Email,
                        Message,
                        callbackUrl
                    ...
                    await _mailService.SendEmailAsync(Input.Email, subject, messageBody);
